...
public class DatabaseConfiguration implements EnvironmentAware {
	...
	public DataSource getShardingDataSource() throws SQLException {
		...
		// new StandardShardingStrategyConfiguration("order_id", new
	...
	public DataSource createDataSource() throws SQLException {
		...
		druidDataSource.setTimeBetweenEvictionRunsMillis(
				Integer.parseInt(datasourcePropertyResolver.getProperty("timeBetweenEvictionRunsMillis")));
		druidDataSource.setMinEvictableIdleTimeMillis(
				Integer.parseInt(datasourcePropertyResolver.getProperty("minEvictableIdleTimeMillis")));
		...
		druidDataSource.setPoolPreparedStatements(
				Boolean.parseBoolean(datasourcePropertyResolver.getProperty("poolPreparedStatements")));
		druidDataSource.setMaxOpenPreparedStatements(
				Integer.parseInt(datasourcePropertyResolver.getProperty("maxOpenPreparedStatements")));
