...
import com.ripple.mplus.generator.config.DataSourceConfig;
import com.ripple.mplus.generator.config.GlobalConfig;
import com.ripple.mplus.generator.config.PackageConfig;
import com.ripple.mplus.generator.config.StrategyConfig;
import com.ripple.mplus.generator.config.TemplateConfig;
import com.ripple.mplus.generator.config.converts.MySqlTypeConvert;
import com.ripple.mplus.generator.config.po.TableFill;
import com.ripple.mplus.generator.config.rules.DbColumnType;
import com.ripple.mplus.generator.config.rules.DbType;
import com.ripple.mplus.generator.config.rules.NamingStrategy;

public class Generator {

	public static void doGenerator(String author, final String dir, String project_url, String tablePrefix,
			String table_name, final boolean isNeedController, final boolean isNeedService) {
		// 自定义需要填充的字段
				...
				// .setLogicDeleteFieldName("is_delete")
					...
					{// 包配置
						...
						add(new PackageConfig().setModuleName("XX-dal.src.main.resources").setParent("com.XX.project")// 自定义包路径//
								...
								.setEntity(null).setMapper(null).setService(null).setServiceImpl(null)
								.setController(null).setFacacde(null).setFacacdeImpl(null));
						if (isNeedService) {
						...
						if (isNeedController) {
							...
							add(
									...
									new PackageConfig().setModuleName("XX-webapp.src.main.java")
											...
											.setFacacdeImpl(null).setMapper(null).setXml(null));
						}
					}
				}).setCfg(
